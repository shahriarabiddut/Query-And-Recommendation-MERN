...
const QueryCard = ({query,}) => {
  ...
  return (
    <section >
    <div className="card bg-base-100 border-2 border-blue-400">
        <div className="card-body font-barlow">
            ...
            <NavLink to={`/queries/${query._id}`}> <button className=" bg-blue-600 rounded-xl cursor-pointer p-2 w-full text-xl text-white">View</button> </NavLink>
            </div>
        </div>
    </div>
    </section>
